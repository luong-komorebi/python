...
class CoordinationV1Api(object):
    ...
    def create_namespaced_lease_with_http_info(self, namespace, body, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    f"Got an unexpected keyword argument '{key}' to method create_namespaced_lease"
                )
    ...
    def delete_collection_namespaced_lease_with_http_info(self, namespace, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    f"Got an unexpected keyword argument '{key}' to method delete_collection_namespaced_lease"
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'namespace' is set
    ...
    def delete_namespaced_lease_with_http_info(self, name, namespace, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    f"Got an unexpected keyword argument '{key}' to method delete_namespaced_lease"
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def list_lease_for_all_namespaces_with_http_info(self, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    f"Got an unexpected keyword argument '{key}' to method list_lease_for_all_namespaces"
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def list_namespaced_lease_with_http_info(self, namespace, **kwargs):    # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    f"Got an unexpected keyword argument '{key}' to method list_namespaced_lease"
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'namespace' is set
